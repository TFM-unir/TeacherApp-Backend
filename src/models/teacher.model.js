...
const selectAllTeachers = () => {
    return db.query(`SELECT t.id, t.user_id, u.name, u.nickname, u.date_of_birth, u.status, u.photo, u.role_id, l.latitude, l.longitude, l.address, l.city, l.province, t.experience, t.class_mode_online, t.class_mode_in_person, t.price_hour, t.about_me, s.subject, r.rating, d.department_name 
    FROM teachers as t 
